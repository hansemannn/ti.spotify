...
exports.init = function (logger, config, cli, appc) {
	cli.on('build.ios.xcodeproject', {
		pre: function (data) {
			...
			var moduleId = 'ti.spotify';
			var moduleVersion = '1.0.0';
			var scriptPath = null; // '<path-to-strip-frameworks-script>/strip-frameworks.sh'; // Or set to null if not required
			var frameworkPaths = [
				'../../modules/iphone/' + moduleId + '/' + moduleVersion + '/platform/SpotifyAudioPlayback.framework',
				'../../modules/iphone/' + moduleId + '/' + moduleVersion + '/platform/SpotifyAuthentication.framework'
			];
